...
try:
    ...
    print(f"Starting web service: {base_url}")
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            {"role": "system",
             ...
             Evaluate the users request like a senior engineer. 
             If you don't know the answer, say you don't know. 
             If the user asks for code, provide a code snippet in a code block.
             """},
        ],
        stream=True,
    )
